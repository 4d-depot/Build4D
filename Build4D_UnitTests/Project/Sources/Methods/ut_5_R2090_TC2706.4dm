...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4d.BuildApp.dataless"]="true"; "(Current project) Info.plist com.4d.BuildApp.dataless Key should have value: true")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4d.BuildApp.dataless"]="true"; "(External project) Info.plist com.4d.BuildApp.dataless Key should have value: true")
