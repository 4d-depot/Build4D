...
// build a client application , setting the ClientuserPreferencesFolderByPath (4D_MultipleClient key)
...
If ($infoPlist.exists)
	...
	ASSERT($infos["4D_MultipleClient"]="1"; "(Current project) Info.plist 4D_MultipleClient Key should have value: 1")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["4D_MultipleClient"]="1"; "(External project) Info.plist 4D_MultipleClient Key should have value: 1")
