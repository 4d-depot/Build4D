...
If ($infoPlist.exists)
	$infos:=$infoPlist.getAppInfo()
	ASSERT($infos["com.4D.BuildApp.LastDataPathLookup"]=$settings.buildName; "(External project) Info.plist com.4D.BuildApp.LastDataPathLookup Key should have value: ByAppName")
Else 
