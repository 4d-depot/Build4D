...
//Enable the automatic data collection using the serverDataCollection = false
...
$settings.serverDataCollection:=False
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4d.dataCollection"]="False"; "(Current project) Info.plist com.4d.dataCollection Key should have value: False")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4d.dataCollection"]="False"; "(External project) Info.plist com.4d.dataCollection Key should have value: False")
