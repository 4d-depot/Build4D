...
// Hide the data explorer item menu using the hideDataExplorerMenuItem = true
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4D.HideDataExplorerMenuItem"]="True"; "(Current project) Info.plist com.4D.HideDataExplorerMenuItem Key should have value: True")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4D.HideDataExplorerMenuItem"]="true"; "(External project) Info.plist com.4D.HideDataExplorerMenuItem Key should have value: true")
