...
// Build a client application setting the ClientServerSystemFolderName
...
$settings.clientServerSystemFolderName:="myBeautifullApp"
...
If ($infoPlist.exists)
	...
	ASSERT($infos["BuildCacheFolderNameClient"]="myBeautifullApp"; "(Current project) Info.plist BuildCacheFolderNameClient Key should have value: \"myBeautifullApp\"")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["BuildCacheFolderNameClient"]="myBeautifullApp"; "(External project) Info.plist BuildCacheFolderNameClient Key should have value: \"myBeautifullApp\"")
