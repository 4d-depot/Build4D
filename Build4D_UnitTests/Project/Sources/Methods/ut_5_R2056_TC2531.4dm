//%attributes = {}
// build a server application with a specific rangeVersMin
...
If ($infoPlist.exists)
	...
	ASSERT($infos["BuildRangeVersMin"]="8"; "(Current project) Info.plist BuildRangeVersMin Key should have value: 8.")
Else 
...
If ($infoPlist.exists)
	$infos:=$infoPlist.getAppInfo()
	ASSERT($infos["BuildRangeVersMin"]="8"; "(External project) Info.plist BuildRangeVersMin Key should have value: 8")
Else 
