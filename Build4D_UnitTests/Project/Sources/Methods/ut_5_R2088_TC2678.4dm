...
// build a client application without setting the ClientuserPreferencesFolderByPath
...
If ($infoPlist.exists)
	...
	ASSERT($infos["4D_MultipleClient"]=Null; "(Current project) Info.plist 4D_MultipleClient Key should'nt be present")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["4D_MultipleClient"]=Null; "(External project) Info.plist 4D_MultipleClient Key should'nt be present")
