...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4D.HideRuntimeExplorerMenuItem"]="True"; "(Current project) Info.plist com.4D.HideRuntimeExplorerMenuItem Key should have value: True")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4D.HideRuntimeExplorerMenuItem"]="true"; "(External project) Info.plist com.4D.HideRuntimeExplorerMenuItem Key should have value: true")
