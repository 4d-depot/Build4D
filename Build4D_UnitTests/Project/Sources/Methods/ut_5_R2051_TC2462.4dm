...
// Not set the serverDataCollection key to check the default value
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4d.dataCollection"]="true"; "(Current project) Info.plist com.4d.dataCollection Key should have value: true")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4d.dataCollection"]="true"; "(External project) Info.plist com.4d.dataCollection Key should have value: true")
