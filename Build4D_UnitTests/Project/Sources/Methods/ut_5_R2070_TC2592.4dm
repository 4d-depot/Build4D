//%attributes = {}
// build the client application specifying the application internalName
...
$settings.versioning:={}
$settings.versioning.internalName:="theInternalName"
...
Else 
	...
	If ($exeFile.exists)
		...
		ASSERT($infos.InternalName="theInternalName"; "(Current project) Client internalName should be set (https://github.com/orgs/4d/projects/119/views/4?pane=issue&itemId=37680117")
