...
$settings.serverStructureFolderName:="my_app"
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4d.ServerCacheFolderName"]=$settings.serverStructureFolderName; "(Current project) Info.plist \"com.4d.ServerCacheFolderName\" Key should have value: "+$settings.serverStructureFolderName)
