...
// Build a client application without setting the ClienServerSystemFolderName
...
If ($infoPlist.exists)
	...
	ASSERT($infos["BuildCacheFolderNameClient"]=Null; "(Current project) Info.plist BuildCacheFolderNameClient Key should'nt exist")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["BuildCacheFolderNameClient"]=Null; "(External project) Info.plist BuildCacheFolderNameClient Key should'nt exist")
