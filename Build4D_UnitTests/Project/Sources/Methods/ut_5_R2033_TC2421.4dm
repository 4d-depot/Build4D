//%attributes = {}
// Build a compiled project and create a read-only .4DZ packed file (default value)
...
If ($success)
	...
	ASSERT($4DZ.exists; "(Current project) Compiled project 4DZ file should not exist: "+$4DZ.platformPath+$link)
