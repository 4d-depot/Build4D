...
If ($infoPlist.exists)
	...
	ASSERT($infos["SDIRuntime"]="0"; "(Current project) Info.plist SDIRuntime Key should have value: 0")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["SDIRuntime"]="0"; "(External project) Info.plist SDIRuntime Key should have value: 0")
