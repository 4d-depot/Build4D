//%attributes = {}
// Check the custom elevation right for the Updater (elevated)
If (Is Windows)  // Only on Windows
	...
	ASSERT($manifestContent="@level=\"requireAdministrator\"@"; "(Current project) Standalone Updater manifest should contain elevated rights"+$link)
	...
	$manifestContent:=$manifestFile.getText()
	ASSERT($manifestContent="@level=\"requireAdministrator\"@"; "(External project) Standalone Updater manifest should contain elevated rights"+$link)
