...
// Not hide the Administration Window item menu using the hideAdministrationWindowMenuItem = false
...
$settings.hideAdministrationWindowMenuItem:=False
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4D.HideAdministrationWindowMenuItem"]="False"; "(Current project) Info.plist com.4D.HideAdministrationWindowMenuItem Key should have value: False")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["com.4D.HideAdministrationWindowMenuItem"]="False"; "(External project) Info.plist com.4D.HideAdministrationWindowMenuItem Key should have value: False")
