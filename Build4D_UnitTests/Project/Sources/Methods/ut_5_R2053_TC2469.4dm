...
If ($infoPlist.exists)
	...
	ASSERT($infos["4D_SingleInstance"]="0"; "(Current project) Info.plist 4D_SingleInstance Key should have value: 0")
...
If ($infoPlist.exists)
	...
	ASSERT($infos["4D_SingleInstance"]="0"; "(External project) Info.plist 4D_SingleInstance Key should have value: 0")
