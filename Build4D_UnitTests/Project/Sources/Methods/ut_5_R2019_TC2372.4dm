...
Else 
	...
	If ($exeFile.exists)
		...
		ASSERT($infos.FileDescription="theFileDescription"; "(Current project) Standalone companyName should be set (https://github.com/orgs/4d/projects/119/views/4?pane=issue&itemId=37680117")
