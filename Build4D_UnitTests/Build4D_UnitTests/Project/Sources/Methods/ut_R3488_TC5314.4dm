//%attributes = {}
// Build an application/component and remove an absolute file path
...
$settings.deletePaths:=New collection(Folder(Folder(fk database folder; *).platformPath; fk platform path).path+"Test/"+$settings.buildName+".4dbase/Resources/UnitTests.txt")
...
$deletedFile:=$build.settings.destinationFolder.file("Resources/component.json")
...
$settings.deletePaths:=New collection(File(Storage.settings.externalProjectRootFolder.path+"Test/"+$settings.buildName+".4dbase/Resources/UnitTests.txt"))
