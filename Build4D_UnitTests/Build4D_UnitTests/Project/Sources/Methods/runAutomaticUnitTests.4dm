...
Storage.settings.rootFolder.file("UT_start.log").setText(Timestamp)  // Write a starting file to check for writing permission
...
If (Not($errorsLogFile.exists))  // If project unit tests failed, no need to perform component unit tests...
