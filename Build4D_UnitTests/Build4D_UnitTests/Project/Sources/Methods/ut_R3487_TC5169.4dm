//%attributes = {}
// Build an application/component and add a folder located at an absolute path to a destination located at a relative path
...
$includedFolder:=$build.settings.destinationFolder.folder("Test/Documentation")
