//%attributes = {}
// Build an application/component and add a file located at a relative path to an undefined destination
...
$includedFile:=$build.settings.destinationFolder.file("README.md")
